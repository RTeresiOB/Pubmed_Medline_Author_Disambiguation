...
//// PUBMED CHANGE ////
template <> const string cAttribute_Basic<cJournal>::class_name = "Journal";
template <> const string cAttribute_Basic<cJournal>::attrib_group = "Article";
template <> const string cAttribute_Basic<cAffiliation_Exists>::class_name = "Affiliation_Exists";
template <> const string cAttribute_Basic<cAffiliation_Exists>::attrib_group = "Article";
template <> const string cAttribute_Basic<cLanguage>::class_name = "Language";
template <> const string cAttribute_Basic<cLanguage>::attrib_group = "Article";
template <> const string cAttribute_Basic<cTitle_Words>::class_name = "Title";
template <> const string cAttribute_Basic<cTitle_Words>::attrib_group = "Article";
template <> const string cAttribute_Basic<cMeSH>::class_name = "MeSH";
...
template <> const string cAttribute_Basic<cCoauthor>::attrib_group = "Article";
