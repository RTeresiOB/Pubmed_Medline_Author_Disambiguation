 ...
 *
 * Example:
 * 1. cSort_by_attrib obj1( "Article" ); this will create an instance obj1 which compares two cRecord pointers based on the "Article" information column.
 ...
 *    		the way of sorting is through comparison of "Article" attribute. Binary tree is ideal for fast search, insertion and deletion.
 *
 */
